...
async def lifespan(app: FastAPI):
    ...
    logger.info(
        ...
        extra={"uptime_seconds": time.time() - startup_time},
    )
...
async def get_system_status(request: Request):
    ...
    try:
        ...
        return JSONResponse(
            status_code=503,
            content={"status": "degraded", "error": "System status check failed"},
        )


# ============================================================
# IMPORT AND INCLUDE ALL ROUTERS - DO NOT REMOVE ANY OF THESE
# ============================================================
